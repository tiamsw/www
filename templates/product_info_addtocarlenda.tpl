    	...
    	<div class="events">
            ...
            <div class="events-c">
            	<div class="row">
                    ...
                    <p class="time">Saturday, 31 Aug 2013 19:30 BST <a href="#">+ 1 más fechas</a></p>
                    <p class="mt15"><a href="#" class="btn btn-range btn-Calendar">En tu Calendario</a></p>
                </div>
            ...
            <div class="events-r mt15">
            	<div class="r-row rw-bg">
                    ...
                    <a href="#" class="Fbot mt15">Más Detalles</a>
                </div>
                <div class="r-row rw-bg">
                	<h3>Evento principal</h3>
                    <font>August 25th, 20:00hrs</font>
