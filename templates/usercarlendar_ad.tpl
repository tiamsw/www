...
<div class="mian">
    <div class="content">
    	<div class="events">
						<div class="gigs-1">
		                <span>
		                    <a href="#" id="newcaledar" class="fl btn btn-black-2">Nueva entrada del Calendario</a>
		                    <a href="#" class="fl btn btn-black-3">Exportar tu Calendario</a>
		                </span>
		                <p class=" mt15 gigs-top-xx fr"> 
		                     
		                    <a class="btn-hs2 btn-Calendar left-by" id="agendaDay"
							onclick="switchview(id)">Día</a> 
							<a class="btn-hs2 btn-Calendar"
							id="agendaWeek" onclick="switchview(id)">Semana</a> 
							<a id="month"
							class="btn-hs2 btn-Calendar by-hover" id="month"
							onclick="switchview(id)">Mes</a>
				...
				<div class="row3 map gigs_top">
					<span class="fl"><a href="javascript:void(0);"
						class="btn btn-blue btn-Calendar ml15 updateBtn">Editar</a><font><a
							...
							onclick="javascript:closewin('tcbox');">Cancelar</a></font></span>
